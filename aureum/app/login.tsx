          ...
          <form className="space-y-4" onSubmit={(e) => { e.preventDefault(); onLogin(email); }}>
            <div className="relative">
              ...
              <input 
                ...
                className="w-full pl-14 pr-6 py-5 bg-slate-50 border-none rounded-2xl focus:ring-4 ring-[#FFD200]/20 outline-none font-bold text-[#003366] text-sm transition-all" 
              />
            </div>
            <div className="relative">
              <Lock className="absolute left-5 top-1/2 -translate-y-1/2 w-4 h-4 text-slate-300" />
              <input type="password" required placeholder="Security Key" className="w-full pl-14 pr-6 py-5 bg-slate-50 border-none rounded-2xl focus:ring-4 ring-[#FFD200]/20 outline-none font-bold text-[#003366] text-sm transition-all" />
            </div>
